...
<!-- For checkpoint task examples and patterns, see @~/.claude/get-paper-done/references/checkpoints.md -->
...
See `~/.claude/get-paper-done/references/tdd.md` for TDD plan structure.
...
See `~/.claude/get-paper-done/templates/user-setup.md` for full paper structure and examples
...
See `~/.claude/get-paper-done/workflows/verify-phase.md` for verification logic.
