...
│   └── gpd/           # GPD-specific commands
├── get-paper-done/     # Skill resources
...
**New Template:**
- Implementation: `get-paper-done/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `get-paper-done/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/get-paper-done/workflows/{name}.md`

**New Reference Document:**
- Implementation: `get-paper-done/references/{name}.md`
