...
/**
 * GPD Tools — CLI utility for GPD workflow operations
 *
 * Replaces repetitive inline bash patterns across ~50 GPD command/workflow/agent files.
 * Centralizes: config parsing, model resolution, phase lookup, git commits, summary verification.
 *
 * Usage: node gpd-tools.cjs <command> [args] [--raw]
 *
 * Atomic Commands:
