...
**Using gpd-tools.cjs (preferred):**

```bash
# Commit with automatic commit_docs + gitignore checks:
node ~/.claude/get-paper-done/bin/papergen-tools.cjs commit "docs: update state" --files .planning/STATE.md
...
- Branch name from `phase_branch_template` (e.g., `gpd/phase-03-citation verification`)
...
- Branch name from `milestone_branch_template` (e.g., `gpd/v1.0-mvp`)
