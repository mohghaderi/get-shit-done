<purpose>
Switch the model profile used by GPD agents. Controls which Claude model each agent uses, balancing quality vs token spend.
</purpose>
...
[Show table from MODEL_PROFILES in papergen-tools.cjs for selected profile]

Example:
| Agent | Model |
|-------|-------|
| papergen-planner | opus |
| papergen-executor | sonnet |
| papergen-verifier | haiku |
| ... | ... |
